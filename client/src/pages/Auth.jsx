...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    console.log('[Auth] VITE_GOOGLE_CLIENT_ID:', clientId ? `${clientId.slice(0, 20)}…` : 'MISSING');
    if (!clientId) return;
    ...
    script.onerror = () => {
      console.error('[Auth] Failed to load GSI script');
    };
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <div className="auth-logo" onClick={() => navigate('/')}>GetFrench</div>
